...
# Keep dashboard reads small and cached so demo actions stay responsive.
...
def format_missing_client_fields_message(missing):
    if not missing:
        return ""
    return (
        "Receptionist: I can start the internal LifecycleDesk AI meeting after I have all client details. "
